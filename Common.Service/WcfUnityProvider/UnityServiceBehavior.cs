...
namespace Common.Service.WcfUnityProvider
{
    public class UnityServiceBehavior : IServiceBehavior
    {
        ...
        public void ApplyDispatchBehavior(ServiceDescription serviceDescription, ServiceHostBase serviceHostBase)
        {
            ...
            channelDispatchers.SelectMany(channelDispatcher => channelDispatcher.Endpoints)
                .ForEach(endPoints => endPoints.DispatchRuntime.InstanceProvider = new UnityInstanceProvider(this.container, serviceDescription.ServiceType));

            ////foreach (EndpointDispatcher endpointDispatcher in serviceHostBase.ChannelDispatchers.Cast<ChannelDispatcher>()
